...
// Private methods
//-----------------------------------------------------------------------------
static inline imgpel filter_safe_positions(const ImgProcessFilter1D *flt,
                                           const imgpel *p_in,
                                           int stride_in_imgpel)
{
...
static inline imgpel filter_unsafe_up_positions(const ImgProcessFilter1D *flt,
                                                const imgpel *p_in,
                                                int up_samples,
                                                int stride_in_imgpel)
{
...
static inline imgpel filter_unsafe_down_positions(const ImgProcessFilter1D *flt,
                                                  const imgpel *p_in,
                                                  int down_samples,
                                                  int stride_in_imgpel)
{
...
static inline imgpel filter_even_unsafe_down_positions(const ImgProcessFilter1D *flt,
                                                       const imgpel *p_in,
                                                       int down_samples,
                                                       int stride_in_imgpel)
{
...
void img_process_filter_vert_line(const ImgProcessFilter1D *flt,
                                  const imgpel *p_in,
                                  imgpel *p_out,
                                  int origin_x,
                                  int end_x,
...
static void img_process_filter_even_vert_line(const ImgProcessFilter1D *flt,
                                              const imgpel *p_in,
                                              imgpel *p_out,
                                              int origin_x,
                                              int end_x,
...
void H264AVCEncoderTest::tabMux(UChar *output,
                                Int iStrideOut,
                                UChar *input0,
                                UChar *input1,
                                Int iStrideIn,
...
void H264AVCEncoderTest::tabMuxFR(UChar *output,
                                  Int iStrideOut,
                                  UChar *input0,
                                  UChar *input1,
                                  Int iStrideIn,
