...
ErrVal WriteYuvToFile::create(WriteYuvToFile*& rpcWriteYuv)
{
...
ErrVal WriteYuvToFile::init(const std::string& rcFileName)
{
    ROF(rcFileName.size());
