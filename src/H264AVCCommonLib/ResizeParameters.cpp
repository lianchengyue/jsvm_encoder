...
ErrVal ResizeParameters::readPictureParameters(FILE* pFile, Bool bFrameMbsOnlyFlag)
{
    ROF(pFile );
...
Void ResizeParameters::updateCurrLayerParameters(const SliceHeader& rcSH)
{
...
Void ResizeParameters::updateRefLayerParameters(const SliceHeader& rcSH)
{
...
Void ResizeParameters::updatePicParameters(const PictureParameters& rcPP )
{
