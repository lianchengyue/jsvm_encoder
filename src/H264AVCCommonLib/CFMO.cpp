...
Void FMO::GenerateType0MapUnitMap()
{
    ...
    do
    {
        for(iGroup = 0; (iGroup <= pps_.num_slice_groups_minus1) && (i < PicSizeInMapUnits_); i += pps_.run_length_minus1[iGroup++] + 1)
        {
...
Int FMO::getNextSliceGroupId( Int iPrevSliceGroupId )
{
