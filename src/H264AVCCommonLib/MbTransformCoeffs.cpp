...
Bool MbTransformCoeffs::allCoeffsZero() const
{
...
Bool MbTransformCoeffs::allLevelsZero() const
{
    const TCoeff* pcDst = get(B4x4Idx(0));
    for(UInt ui = 0; ui < 384; ui++)
    {
...
Void MbTransformCoeffs::clearLumaLevels()
{
    ::memset(&m_aaiLevel[0][0], 0, sizeof(TCoeff)*16*16);
}

Void MbTransformCoeffs::clearChromaLevels()
{
    ::memset(get(CIdx(0)), 0, sizeof(TCoeff)*128);
}

Void MbTransformCoeffs::clearLumaLevels4x4(LumaIdx c4x4Idx)
{
...
Void MbTransformCoeffs::clearNewLumaLevels(MbTransformCoeffs& rcBaseMbTCoeffs)
{
...
Void MbTransformCoeffs::clearNewLumaLevels8x8(B8x8Idx c8x8Idx, MbTransformCoeffs&  rcBaseMbTCoeffs)
{
...
Void MbTransformCoeffs::clearNewLumaLevels8x8Block(B8x8Idx c8x8Idx, MbTransformCoeffs& rcBaseMbTCoeffs)
{
...
Void MbTransformCoeffs::storeLevelData()
{
...
Void MbTransformCoeffs::switchLevelCoeffData()
{
    TCoeff sTemp;
