#ifndef _GOPENCODER_H_
#define _GOPENCODER_H_
...
public:
    ...
    ErrVal  CreatNonRequiredSei()                      { SEI::NonRequiredSei::create(m_pcNonRequiredSei); return Err::m_nOK; }
    ErrVal  CreatIntegrityCheckSei()                   { SEI::IntegrityCheckSEI::create(m_pcIntegrityCheckSei); return Err::m_nOK; }
