...
ErrVal CodingParameter::check()
{
    ...
    xCheckAndSetProfiles();

    return Err::m_nOK;
}


ErrVal CodingParameter::xCheckAndSetProfiles()
{
    for( UInt uiLayer = 0; uiLayer < m_uiNumberOfLayers; uiLayer++ )
    {
        m_acLayerParameters[uiLayer].setAndCheckProfile(this);
    }
    return Err::m_nOK;
}

ErrVal LayerParameters::setAndCheckProfile( CodingParameter* pcCodingParameter )
{
    ...
    if(m_uiLayerId == 0)
    {
        ...
        if(bForceMain)
            xForceMainProfile(pcCodingParameter);

        if(bForceExtended)
            xForceExtendedProfile(pcCodingParameter);

        if(bForceHigh)
            xForceHighProfile(pcCodingParameter);
        //----- check compatibility -----
    ...
    if(bForceScalBase)
        xForceScalableBaselineProfile(pcCodingParameter);
...
ErrVal LayerParameters::updateWithLevel( CodingParameter* pcCodingParameter, UInt& ruiLevelIdc )
{
    if( m_uiLevelIdc )
    {
        switch( m_uiLevelIdc )
...
Bool LayerParameters::xIsBaselineProfile( CodingParameter* pcCodingParameter )
{
...
ErrVal LayerParameters::xForceBaselineProfile( CodingParameter* pcCodingParameter )
{
    ROT( m_uiLayerId );
...
Bool LayerParameters::xIsMainProfile( CodingParameter* pcCodingParameter )
{
    ROFRS( m_uiLayerId                    == 0,                       false );
    ROFRS( m_uiBaseLayerId                == MSYS_UINT_MAX,           false );
    ROFRS( m_uiScalingMatricesPresent     == 0,                       false );
...
ErrVal LayerParameters::xForceMainProfile( CodingParameter* pcCodingParameter )
{
    ROT( m_uiLayerId );
    ROF( m_uiBaseLayerId == MSYS_UINT_MAX );
...
Bool LayerParameters::xIsExtendedProfile( CodingParameter* pcCodingParameter )
{
    ROFRS( m_uiLayerId                    == 0,                       false );
    ROFRS( m_uiBaseLayerId                == MSYS_UINT_MAX,           false );
    ROFRS( m_uiScalingMatricesPresent     == 0,                       false );
...
ErrVal LayerParameters::xForceExtendedProfile( CodingParameter* pcCodingParameter )
{
    ROT( m_uiLayerId );
    ROF( m_uiBaseLayerId == MSYS_UINT_MAX );
...
Bool LayerParameters::xIsHighProfile( CodingParameter* pcCodingParameter )
{
    ROFRS( m_uiLayerId                    == 0,               false );
    ROFRS( m_uiBaseLayerId                == MSYS_UINT_MAX,   false );
    ROFRS( m_uiNumSliceGroupsMinus1       == 0,               false );
...
ErrVal LayerParameters::xForceHighProfile( CodingParameter* pcCodingParameter )
{
    ROT( m_uiLayerId );
    ROF( m_uiBaseLayerId == MSYS_UINT_MAX );
...
Bool LayerParameters::xIsIntraOnly( CodingParameter* pcCodingParameter )
{
...
Bool LayerParameters::xHasRestrictedESS( CodingParameter* pcCodingParameter )
{
    ROTRS( m_uiBaseLayerId                            == MSYS_UINT_MAX, true  );
...
Bool LayerParameters::xIsScalableBaselineProfile( CodingParameter* pcCodingParameter )
{
    ROFRS( m_uiLayerId               > 0,                       false );
    ROFRS( m_uiMbAff                == 0,                       false );
    ROFRS( m_uiPAff                 == 0,                       false );
...
ErrVal LayerParameters::xForceScalableBaselineProfile( CodingParameter* pcCodingParameter )
{
    ROF( m_uiLayerId );
...
Bool LayerParameters::xIsScalableHighProfile( CodingParameter* pcCodingParameter )
{
    ROFRS( m_uiLayerId               > 0,                       false );
    ROFRS( m_uiNumSliceGroupsMinus1 == 0,                       false );
    ROFRS( m_uiUseRedundantSlice    == 0,                       false );
...
ErrVal LayerParameters::xForceScalableHighProfile( CodingParameter* pcCodingParameter )
{
    ROF( m_uiLayerId );
