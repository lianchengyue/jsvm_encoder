                              ...
                              SampleWeighting*  pcSampleWeighting)
{
    ...
    MotionEstimationCost::xInit((m_cParams.getSearchRange() << 2), pcRateDistortionIf);
...
#define TZ_SEARCH_CONFIGURATION                                                                                 \
  const Int  iRaster                  = 3;  /* TZ soll von aussen \FCbergeben werden */                           \
