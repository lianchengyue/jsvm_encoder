...
ErrVal MotionEstimationCost::xInit(const Int iSubPelSearchLimit, RateDistortionIf* pcRateDistortionIf)
{
...
ErrVal MotionEstimationCost::xSetMEPars(const UInt uiMvScaleShift, const Bool bSad)
{
...
UInt MotionEstimationCost::xGetComponentBits(Int iPos) const
{
    UInt uiCodeLength = 1;
