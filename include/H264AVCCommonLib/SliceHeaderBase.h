#ifndef _SLICEHEADERBASE_H_
#define _SLICEHEADERBASE_H_
...
public:
    ...
    ReOrderingOfPicNumsIdc getCommand(UInt& ruiValue) const
    {
        ruiValue = m_uiValue;
        return m_eReOrderingOfPicNumsIdc;
    }
    ReOrderingOfPicNumsIdc getCommand() const
    {
        return m_eReOrderingOfPicNumsIdc;
    }
    UInt getValue() const
    ...
    Bool isEnd() const
    {
        return m_eReOrderingOfPicNumsIdc == RPLR_END;
    }


    Bool operator != (const RplrCommand&  rcRplrCommand) const
    {
        return m_eReOrderingOfPicNumsIdc != rcRplrCommand.m_eReOrderingOfPicNumsIdc || m_uiValue != rcRplrCommand.m_uiValue;
    }

    const RplrCommand& operator = (const RplrCommand&  rcRplrCommand)
    {
        copy(rcRplrCommand);
        return *this;
    }
...
class RefPicListReOrdering : public StatBuf< RplrCommand, 33 >
{
public:
...
public:
    ...
    Mmco getCommand (UInt& ruiValue1, UInt& ruiValue2) const
    {
        ruiValue1 = m_uiValue1, ruiValue2 = m_uiValue2;
        return m_eMmco;
    }
    Mmco getCommand() const
    {
        return m_eMmco;
    }
    UInt getValue1() const
    {
        return m_uiValue1;
    }
    UInt getValue2() const
    {
        return m_uiValue2;
    }
    Bool isEnd() const
    {
        return m_eMmco == MMCO_END;
    }

    Bool operator != (const MmcoCommand& rcMmcoCommand) const
    {
...
class DecRefPicMarking : public StatBuf< MmcoCommand, 33 >
{
public:
...
class PredWeightTable : public StatBuf< PredWeight, 32 >
{
public:
    PredWeightTable();
    ...
    const PredWeightTable& operator = (const PredWeightTable& rcPredWeightTable)
    {
        copy(rcPredWeightTable);
        return *this;
    }
};


class DBFilterParameter
{
public:
...
class AUDelimiter : public NalUnitHeader
{
public:
    AUDelimiter();
...
class EndOfSequence : public NalUnitHeader
{
public:
    EndOfSequence();
...
class EndOfStream : public NalUnitHeader
{
public:
    EndOfStream();
...
class FillerData : public NalUnitHeader
{
public:
    FillerData();
...
class PrefixHeader : public NalUnitHeader
{
public:
    PrefixHeader();
...
class SliceHeaderSyntax : public PrefixHeader
{
public:
    SliceHeaderSyntax();
