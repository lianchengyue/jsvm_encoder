...
public:
    ...
    class ScalableSei: public SEIMessage
    {
    protected:
        ScalableSei ();
        virtual ~ScalableSei();
...
//JVT-W046 }
  ...
  // BUG_FIX liuhui}
    ...
    class SubPicSei : public SEIMessage
    {
    protected:
        SubPicSei ();
        ~SubPicSei();
    ...
    class MotionSEI : public SEIMessage
    {
    ...
    class PriorityLevelSEI : public SEIMessage
    {
    protected:
        PriorityLevelSEI ();
        ~PriorityLevelSEI();
    ...
    class NonRequiredSei : public SEIMessage
    {
    protected:
        NonRequiredSei();
        ~NonRequiredSei();
    ...
    // JVT-S080 LMI {
    class ScalableSeiLayersNotPresent: public SEIMessage
    {
    protected:
    ...
    class ScalableSeiDependencyChange: public SEIMessage
    {
    protected:
  ...
  #define MAX_LREP_IN_ACCESS_UNIT 50
    ...
    class SceneInfoSei : public SEIMessage
    {
    protected:
    ...
    // JVT-V068 HRD {
    class BufferingPeriod : public SEIMessage
    {
    ...
    class PicTiming : public SEIMessage
    {
    ...
    class AVCCompatibleHRD : public SEIMessage
    {
    public:
...
//JVT-W049 {
    class RedundantPicSei: public SEIMessage
    {
    protected:
        RedundantPicSei ();
        ~RedundantPicSei ();
...
//JVT-W049 }
    ...
    //JVT-W052 wxwan
    class IntegrityCheckSEI : public SEIMessage
    {
    protected:
    ...
    //JVT-W052 wxwan
    //JVT-X032 {
    class TLSwitchingPointSei: public SEIMessage
    {
    protected:
        TLSwitchingPointSei();
        ~TLSwitchingPointSei();
...
//JVT-X032 }
    ...
    //JVT-W062 {
    class Tl0DepRepIdxSei : public SEIMessage
    {
    protected:
        Tl0DepRepIdxSei();
        ~Tl0DepRepIdxSei();
...
//JVT-W062 }
    ...
    class UnsupportedSei : public SEIMessage
    {
    protected:
