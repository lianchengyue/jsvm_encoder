#ifndef _MEMACCESSOR_H_
#define _MEMACCESSOR_H_
...
private:
    T* m_pcT;        //current pos
    T* m_pcOrigT;    //origin pos
    UInt m_uiSize;   //toatal size
    UInt m_uiUsableSize;  //unused size
};



template<class T> class MemAccessList
{
public:
